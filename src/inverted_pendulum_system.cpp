#include "inverted_pendulum_control/inverted_pendulum_system.hpp"
...
std::vector<hardware_interface::CommandInterface> InvertedPendulumSystemHardware::export_command_interfaces()
{
...
{
  RCLCPP_INFO(rclcpp::get_logger("InvertedPendulumSystemHardware"), "Reading...");
...
hardware_interface::return_type inverted_pendulum_control::InvertedPendulumSystemHardware::write()
{
  ...
  for (auto i = 0u; i < hw_commands_.size(); i++)
  {
    ...
    RCLCPP_INFO(
      rclcpp::get_logger("InvertedPendulumSystemHardware"), "Got command %.5f for '%s'!", hw_commands_[i],
...
PLUGINLIB_EXPORT_CLASS(
  inverted_pendulum_control::InvertedPendulumSystemHardware, hardware_interface::SystemInterface)
